...
if (document.querySelector('.char-list')) {
  ...
  document.querySelector('main').addEventListener('click', function () {
    ...
    const authorInfo = character.querySelector('dt').textContent;

    quickView.querySelector('h1').textContent = character.querySelector('.title').textContent;
    quickView.querySelector('h1 + p').textContent = character.querySelector('.desc').textContent;
    quickView.querySelector('header + p').innerHTML = authorInfo;
    quickView.querySelector('header ~ a').href = character.querySelector('dd > a').href;
    quickView.querySelector('.wrapper > img').alt = 'Full image of ' + character.querySelector('.title').textContent;
